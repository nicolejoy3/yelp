...
https://media.giphy.com/media/fnrXW0ig7Jcrtf7SMy/giphy.gif

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I had a challengw with the search bar. When I implemented it into my code, my app would not run so therefore I took it out.
